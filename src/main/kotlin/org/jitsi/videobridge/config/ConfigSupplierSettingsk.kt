...
/**
 * A helper class for overriding config suppliers.  Used
 * as a hook in testing
 */
class ConfigSupplierSettingsk {
    companion object {
        /**
         * The supplier to load the new config.  Overridable for testing
         */
        var configSupplier: () -> ConfigSource = ::NewConfig
        ...
        var commandLineArgsSupplier = { emptyArray<String>()}
    }
}