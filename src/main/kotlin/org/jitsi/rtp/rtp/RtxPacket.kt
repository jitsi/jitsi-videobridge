...
class RtxPacket constructor(
    ...
    fun getOriginalRtpPacket(): RtpPacket {
        return toOtherRtpPacketType { rtpHeader, backingBuffer ->
            ...
            RtpPacket(rtpHeader, backingBuffer)
        }
    }
