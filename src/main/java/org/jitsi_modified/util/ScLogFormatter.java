 ...
 */
package org.jitsi_modified.util;
 ...
 *
 * @author Emil Ivov
 * NOTE(brian): copied this over because I didn't want to add all of Jitsi
 * as a dep (adding only the jitsi-util jar caused maven to complain about
 * not being able to find the pom for that jar?)
 */
