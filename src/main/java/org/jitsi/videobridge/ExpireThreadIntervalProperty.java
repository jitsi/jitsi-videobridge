 ...
 */
public class ExpireThreadIntervalProperty extends AbstractConfigProperty<Integer>
{
    ...
    private static ExpireThreadIntervalProperty singleton = new ExpireThreadIntervalProperty();
    ...
    public static ExpireThreadIntervalProperty getInstance()
    {
        return singleton;
    }
}
