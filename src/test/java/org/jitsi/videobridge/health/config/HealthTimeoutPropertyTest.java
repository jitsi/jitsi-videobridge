...
public class HealthTimeoutPropertyTest
{
    ...
    {
        Config legacyConfig = ConfigFactory.parseString(HealthConfig.HealthTimeoutProperty.legacyPropName + "=60000");
        new ConfigSetup()
            .withLegacyConfig(legacyConfig)
            .withEmptyNewConfig()
            .finishSetup();

        HealthConfig.HealthTimeoutProperty healthTimeoutProp = new HealthConfig.HealthTimeoutProperty();
    ...
    {
        Config newConfig = ConfigFactory.parseString(HealthConfig.HealthTimeoutProperty.propName + "=10 seconds");
        new ConfigSetup()
    ...
    public void doesNotChangeAfterConfigReload()
    {
        ...
        Config changedConfig = ConfigFactory.parseString(HealthConfig.HealthTimeoutProperty.propName + "=90 seconds");
