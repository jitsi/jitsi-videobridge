...
public class Conference
  ...
  /**
   * The <tt>Logger</tt> used by the <tt>Conference</tt> class and its instances
   ...
   * <tt>PropertyChangeEvent</tt>s on behalf of this instance while referencing
   * it by a <tt>WeakReference</tt>.
   */
   ...
   * conference in the terms of Jitsi Videobridge which has a specific (unique)
   * ID and is managed by a conference focus with a specific JID.
   *
   ...
   * initialization of the new instance and from whom further/future requests to
   * manage the new instance must come or they will be ignored. Pass
   ...
   * <tt>ColibriConferenceIQ</tt> to the values of the respective properties of
   * this instance. Thus, the specified <tt>iq</tt> may be thought of as a
   ...
   * event/notification, the name of the property and the old and new values of
   * that property
   */
  ...
  /**
   * Notifies this instance that the <tt>SctpConnection</tt> of/associated with
   * a specific <tt>Endpoint</tt> participating in this
  ...
  /**
   * Gets an <tt>Endpoint</tt> participating in this <tt>Conference</tt> which
   * has a specific identifier/ID. If an <tt>Endpoint</tt> participating in this
   * <tt>Conference</tt> with the specified <tt>id</tt> does not exist at the
   * time the method is invoked, the method optionally initializes a new
   ...
   * information for this <tt>Conference</tt>. Creates an instance if none
   * exists.
   *
   ...
   * has a specific identifier/ID. If an <tt>Endpoint</tt> participating in this
   * <tt>Conference</tt> with the specified <tt>id</tt> does not exist at the
   * time the method is invoked, the method initializes a new
   * <tt>Endpoint</tt> instance with the specified <tt>id</tt> and adds it to
   * the list of <tt>Endpoint</tt>s participating in this <tt>Conference</tt>.
   *
   * @param id the identifier/ID of the <tt>Endpoint</tt> which is to be
   ...
   * @return the <tt>TransportManager</tt> instance for the channel-bundle with
   * ID <tt>channelBundleId</tt>, or <tt>null</tt> if one doesn't exist.
   */
  ...
  /**
   * Returns, the <tt>TransportManager</tt> instance for the channel-bundle with
   * ID <tt>channelBundleId</tt>. If no instance exists and
   ...
   * <tt>colibriEndpoint</tt> is used to select the <tt>Endpoint</tt> to update.
   *
