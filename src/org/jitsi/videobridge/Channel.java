...
public abstract class Channel
  ...
  /**
   * The <tt>Logger</tt> used by the <tt>Channel</tt> class and its instances to
   ...
   * <tt>AudioChannel</tt> is to be a part of (or <tt>null</tt> if no it is not
   ...
   * method is a convenience which gets the <tt>BundleContext</tt>
   ...
   * this <tt>Channel</tt>.
   *
   * @return the <tt>Endpoint</tt> of the conference participant associated with
   * this <tt>Channel</tt>
   */
  ...
  /**
   * Gets the <tt>TransportManager</tt> which represents the Jingle transport of
   * this <tt>Channel</tt>. If the <tt>TransportManager</tt> has not been
   * created yet, it is created.
   *
   * @return the <tt>TransportManager</tt> which represents the Jingle transport
   * of this <tt>Channel</tt>
   */
   ...
   * opposed to the responder/answerer) of the media negotiation associated with
  ...
  /**
   * TODO: update this javadoc Starts {@link #stream} if it has not been started
   * yet and if the state of this <tt>Channel</tt> meets the prerequisites to
   * invoke {@link MediaStream#start()}. For example, <tt>MediaStream</tt> may
   * be started only after a <tt>StreamConnector</tt> has been set on it and
   * this
