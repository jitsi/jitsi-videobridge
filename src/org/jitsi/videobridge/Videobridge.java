...
public class Videobridge {
  ...
  /**
   * The name of the property which specifies the FQN name of the RTCP strategy
   * to use when there are less than 3 participants.
   */
   ...
   * shutdown mode. For XMPP API this is "from" JID. In case of REST the source
   * IP is being copied into the "from" field of the IQ.
   */
   ...
   * the new instance to the list of existing <tt>Conference</tt>
   ...
   * from the specified <tt>focus</tt> or they will be ignored. If the focus is
   * not specified this safety check is overridden.
   *
   ...
   * <tt>Conference</tt> to get. A <tt>Conference</tt> does not take orders from
   * a (remote) entity other than the conference focus who has initialized it.
   * Pass <tt>null</tt> if you want any participant to be able to modify the
   * conference.
   ...
   * represents the response to the specified request or <tt>null</tt> to reply
   * with <tt>feature-not-implemented</tt>
   ...
   * request to handle
   * @return an <tt>IQ</tt> stanza which represents the response to the
   * specified request or <tt>null</tt> to reply with
  ...
  /**
   * Returns <tt>true</tt> if this instance has entered graceful shutdown mode.
   */
