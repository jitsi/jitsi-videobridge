...
public class Content
  ...
  /**
   * The <tt>Logger</tt> used by the <tt>Content</tt> class and its instances to
   ...
   * <tt>RtpChannel</tt> is to be a part of (or <tt>null</tt> if it is not to be
   * a part of a channel-bundle).
   ...
   * @throws IllegalArgumentException if <tt>SctpConnection</tt> exists already
   * for given <tt>Endpoint</tt>.
   */
  ...
  /**
   * XXX REMOVE Returns a <tt>Channel</tt> of this <tt>Content</tt>, which has
  ...
  /**
   * Sets the RTCP termination strategy of the <tt>rtpTranslator</tt> to the one
   * specified in the rtcpTerminationStrategyFQN parameter.
   *
   */
   ...
   *
   * @param endpoint the <tt>Endpoint</tt> of <tt>SctpConnection</tt> that we're
   * looking for.
   ...
   * @param path the path to the directory into which to store files related to
   * media recording for this <tt>Content</tt>.
   *
