...
import static org.jitsi.videobridge.EndpointMessageTransportConfig.*;

/**
 * Handles the functionality related to sending and receiving COLIBRI messages
 * for a {@link Relay}.
 **/
public class RelayMessageTransport
    ...
    implements ColibriWebSocket.EventHandler
{
    ...
    /**
     * Initializes a new {@link RelayMessageTransport} instance.
     * @param relay the associated {@link Relay}.
...
//
    ...
    private ServerHelloMessage createServerHello()
    {
        ...
        {
            return new ServerHelloMessage(relay.getConference().getVideobridge().getVersion().toString());
        }
        else
        {
...
//        endpoint.setBandwidthAllocationSettings(message);
    ...
    public BridgeChannelMessage receiverVideoConstraint(ReceiverVideoConstraintMessage message)
    {
        ...
        getLogger().debug(
                () -> "Received a maxFrameHeight video constraint from " + relay.getId() + ": " + maxFrameHeight);
