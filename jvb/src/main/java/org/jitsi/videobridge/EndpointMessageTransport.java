 ...
 * for an {@link EndpointK}. Supports two underlying transport mechanisms --
 * WebRTC data channels and {@code WebSocket}s.
 *
 * @author Boris Grozev
 */
public class EndpointMessageTransport
    extends AbstractEndpointMessageTransport<EndpointK>
        ...
        ColibriWebSocket.EventHandler
{
     ...
     * @param endpoint the associated {@link EndpointK}.
